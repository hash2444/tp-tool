...
Download **`TP-Tool-v1.0.7.mcaddon`** from the [releases page](../../releases) (or straight from this repository) and open it - Minecraft imports the packs.
...
<img src="tp-tool.png" alt="TP Tool" width="760">
