...
Everything you need to get **TP Tool** running, step by step. If something goes wrong, check *Troubleshooting* at the end.
...
1. Download **`TP-Tool-v1.0.7.mcaddon`** from the [Releases page](../../releases) - or directly from this repository.
...
- Operators open the whitelist menu with `/scriptevent tpdev:menu` (cheats must be on, or you must be an operator) and tick the players who may use the tool.
- Whitelisted players get the **TP Tool** automatically. Right-click it, pick a player and wait for the 5 second countdown.
- Anyone who is not whitelisted loses the tool as soon as it shows up in their inventory.
